...
var redirect_uri = 'http://www.emotify.rocks:8888/callback'; // Your redirect uri
/**
...
app.get('/logout',function(req,res){
  ...
  res.redirect('http://www.emotify.rocks:8888/index.html');
});
...
app.get('/runpy/:id?',function (req,res) {
  ...
  var options = {
    mode: 'text',
    scriptPath: '/home/ubuntu/emotion_based_spotify/spotifyAPITest',
    args: [req.params.id]
  };
